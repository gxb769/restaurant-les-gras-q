  ...
  return (
    <section className="bg-paper py-[104px]">
      <div className="w-[min(1180px,calc(100%-40px))] mx-auto grid grid-cols-2 gap-11 items-center max-md:grid-cols-1">
        ...
        <div className="relative min-h-[520px] rounded-lg overflow-hidden shadow-[0_24px_80px_rgba(22,19,17,0.28)]">
          <Image
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-3 mt-6 max-sm:grid-cols-1">
            {t.members.map((m) => (
              <div
                key={m.name}
                className="min-h-[138px] p-[18px] border border-ink/[0.1] rounded-lg bg-cream/[0.72]"
              >
